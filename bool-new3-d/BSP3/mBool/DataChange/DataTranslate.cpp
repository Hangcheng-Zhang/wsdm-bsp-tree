...
pair<Triangle_Set, Edge_Set> DataTranslate::TranslatePartitionPlane(bspFaceRenderingInfo& partiPlanes, Mesh& r_PartionPlaneMesh)
{
	double scale = 15;
...
Triangle_Set DataTranslate::TranslateTriangleBSPs(BSPTreeNode* leafNode)
{
	...
	vector<TriangleBSP> fs1 = leafNode->m_FacesA;
	vector<TriangleBSP> fs2 = leafNode->m_FacesB;
