...
class MeshIntersect
	{
	public:
		MeshIntersect(MeshIntersectMeshResult& r_Result, Mesh& p_MeshA, Mesh& p_MeshB, BSPConstructType p_Type = BSPConstructType::SDM, const Tolerance& p_Tolerence = Tolerance());
