...
void CombineOperate::GetMeshFrom2Models(Mesh& r_Mesh1, Mesh& r_Mesh2)
{
	...
	if (m_Type == MeshBoolOperateType::Difference) {
		r_Mesh2 = DataTranslate::TranslateFaceID2Mesh(m_OriginalMeshB, m_OutputFacesFromMeshB, true);
	}
	else {
